...
export default function RecipePage(props) {
    ...
    return (
        ...
        <RecipePrepCookInfo data={{prepTime: recipeData.preparationMinutes, cookTime: recipeData.cookingMinutes, price: recipeData.pricePerServing}}/>
        <RecipeIngredients data={recipeData.extendedIngredients}/>
        <RecipeInstructions data={recipeData.analyzedInstructions}/>
    </React.Fragment>)
  );
};
