...
export default function MediaCard(props) {
    ...
    return (
        <Card style={{maxWidth: 345, height: 305, rounded: false, borderRadius: 20}}>
            <CardActionArea>
                <CardMedia
            ...
            <CardContent style={{padding: "16px 16px 0px"}}>
                    ...
                    <Typography style={{fontFamily: 'Abel', fontWeight: 'bold', overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap"}} variant="h5" component="h2">
                        {props.data.title}
                    </Typography>
                    <Grid container direction="row"
                        ...
                        <Grid style={{textAlign: 'center'}} item xs key={1}>
                            <Typography style={{textSize: '2rem', fontFamily: 'Abel', textDecoration: 'none', variant: "h2"}}>
                                {time}
                            </Typography>
                        </Grid>

                        <Grid style={{textAlign: 'center'}} item xs key={2}>
                            <Typography style={{textSize: '2rem', fontFamily: 'Abel', textDecoration: 'none'}}>
