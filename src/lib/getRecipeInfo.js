...
async function getRecipeInfo() {
    ...
    let data_response = await axios.post('https://stitch.mongodb.com/api/client/v2.0/app/micro-chef-biguy/graphql',
        {"query": "query recipeListData {recipesLists(sortBy: TITLE_ASC, query: {}, limit: 100) {title, image, pricePerServing}}"},
